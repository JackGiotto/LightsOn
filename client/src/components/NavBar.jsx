        ...
        <>
            ...
            <header className={styles.container}>
                ...
                <ul className={styles.navbarList}>
                    <Link to="/dashboard"><li className={styles.navElement}><a>Cruscotto</a></li></Link>
            ...
            <div className={`${styles.accordion} ${isOpen ? styles.open : ''}`}>
                    ...
                    <ul>
                        <Link to="/dashboard" onClick={() => {setOpen(!isOpen)}}><li className={styles.category}>Cruscotto</li></Link>
