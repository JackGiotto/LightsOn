        ...
        <div className={styles.container}>
          <div className={styles.top}>
            ...
            <div className={styles.top1}>
              <h2 className={styles.info}>+13% rispetto alla media: Mercoledì</h2>
